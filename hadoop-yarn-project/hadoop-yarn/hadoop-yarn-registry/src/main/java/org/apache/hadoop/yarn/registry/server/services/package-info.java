 ...
 * <ul>
 *   <li>The {@link org.apache.hadoop.yarn.registry.server.services.RegistryAdminService}</ol>
 *   extends the shared Yarn Registry client with registry setup and 
 *   (potentially asynchronous) administrative actions.
 *   </li>
 *   <li>
 *     The {@link org.apache.hadoop.yarn.registry.server.services.MicroZookeeperService}
 *     is a transient Zookeeper instance bound to the YARN service lifecycle.
 *     It is suitable for testing.
 *   </li>
 *   <li>
 *     The {@link org.apache.hadoop.yarn.registry.server.services.AddingCompositeService}
