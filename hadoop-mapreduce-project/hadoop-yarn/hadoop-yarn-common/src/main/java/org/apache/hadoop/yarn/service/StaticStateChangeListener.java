 ...
 */
public interface StaticStateChangeListener {
   ...
   * @param state the state the service entered. By the time this message is
   * received, there is no guarantee that the service is still in this state
   */
  void stateChanged(Service service, Service.STATE state, long timestamp);
